...
export default function NotFound() {
    return (
        <div className="h-screen flex flex-col items-center justify-center bg-cover bg-center animate-backgroundZoom" style={{ backgroundImage: 'url(/path/to/your/background-image.jpg)' }}>
